...
## Description
I used the [Capital Bikeshare dataset](https://www.kaggle.com/c/bike-sharing-demand/) which contains daily records on the number of bikes rented as well as weather conditions. First, I ran an [exploratory data analysis](https://github.com/lorenanda/bike-demand-prediction/blob/main/project03_eda.ipynb) to detect patterns in the bike rental demand. Second, I used different regression models to predict how many rental bikes are needed at a certain time, based on information about weather conditions and daily patterns:
